...
Dependencies:
  ...
  Notes:
    ...
    2.  There are some stupid dependencies between the files. For example, Game.hpp depends on Character.hpp for Timer.hpp and
        Character.hpp is included with Player.hpp and Enemy.hpp so if you don't include Player.hpp and Enemy.hpp then 1) ??? and 2) you'll
        have to include Timer.hpp, assuming you're still using the timers I made.

  You have to install the libraries yourself because I don't know how to make an installer. Also I made this program on a 2012 Macbook Air
